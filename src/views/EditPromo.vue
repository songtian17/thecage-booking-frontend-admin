<template>
  <div>
    <div class="page-header-nav">
      ...
      <span class="text">Edit Promotion Code</span>
    </div>
  ...
  mounted() {
    this.$axios
      ...
      .then((res) => {
        ...
        this.useLimit = res.data.usage_limit;
        this.usePerUser = res.data.usage_per_user;
        this.selectedDiscountType = res.data.discount_type;
        this.discount = res.data.discount;
        this.selectedValidProducts = this.getNameFromArray(res.data.promo_code_valid_products);
